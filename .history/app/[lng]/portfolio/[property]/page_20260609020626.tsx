...
import { getProperty, getAllPropertySlugs, getRelatedProperties } from "@/sanity/lib/property";
...
export default async function Home({
  ...
  return <PropertyDetailPage property={propertyDetail} relatedProperties={relatedProperties} />;
}
