  ...
  return (
    <div className={styles.vm__section}>
        ...
        <div className={styles.vr__content}>
          <div className={`container ${styles.vrc__container}`}>
            ...
            <div className={styles.vrc__left}>
              <div className={styles.vrc__spanner}>
                <span className={`{styles.circle ${styles.remove}`}></span>
      ...
      <div className={styles.vm__down}>
        ...
        <div className={styles.vr__content2}>
          {ourValues.map((data, i) => (
            <div className={styles.value__box} key={i}>
              <div className={`container ${styles.value__container}`}>
                <div className={styles.vrc__spanner}>
                  <span className={styles.circle}></span>
                  <span className={styles.vrc__span}>{data.name}</span>
                </div>
                <div className={styles.vb__right}>
                  <p className={styles.vrc__p}>{data.text}</p>
                </div>
              </div>
            </div>
          ))}
