          ...
          {teamData.map((data, i) => (
            <SwiperSlide key={i} className={styles.team__wrapper}>
              <div className={styles.team__card}>
                ...
                <div className={styles.tc__context}>
                  <div className={styles.tc__box}>
                    <div className={styles.tcb__left}>
                      <p className={styles.team__p}>{data.name}</p>
                      <span className={styles.team__span}>{data.position}</span>
                    </div>
                    <Link href={data.link} hre>
                      <Linkedin />
                    </Link>
                  </div>
                </div>
