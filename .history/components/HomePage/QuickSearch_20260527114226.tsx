...
const QuickModal = ({ label, options, selectedValue, onSelect } : {label: string, selectedValue: string, options: {key: string, name: string}}) => {
  ...
  return (
    <div className={styles.quick__modal}>
      ...
      <div className={styles.modal}>
        ...
        >
          <span>
            {options.find((opt) => opt.key === selectedValue)?.name}
          </span>
