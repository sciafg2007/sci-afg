          ...
          <div className={styles.fm__left}>
            <div className={styles.fm__wrap}>
              ...
              <div className={styles.other__links}>
                ...
                <Link href="https://wa.me/237675846270" target="_blank">
                  Whatsapp
                </Link>
              </div>
            </div>
          ...
          <div className={styles.fm__right}>
            <div className={styles.fm__wrap}>
              ...
              <div className={styles.other__links}>
                ...
                <Link href="tel:237698402397" target="_blank">
                  +237 698 40 23 97
                </Link>
                <Link
                  href="https://share.google/xaP6Jt8r5mlOiTOya"
                  target="_blank"
                >
                  Immeuble CCA Bonanjo, Douala
                </Link>
              </div>
            </div>
            <div className={styles.fm__wrap}>
