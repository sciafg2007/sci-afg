          ...
          <div className={styles.pbc__right}>
            <div className={styles.pcr__top}>
              <div className={styles.pt__image}>
                <Image
                  alt={property.agent.image.alt ? property.agent.image.alt : property.agent.name}
                  fill
                  src={property.agent.image ?
                    urlFor(property.agent.image).width(1920).url() ||
                    urlFor(property.agent.image).url() : Avatar
                  }
                  sizes="15vw"
                />
              </div>
              <div className={styles.pt__content}></div>
            </div>
