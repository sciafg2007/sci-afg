          ...
          <div className={styles.pbc__right}>
            <div className={styles.pcr__top}>
              ...
              <div className={styles.pt__content}>
                <h4>{property.propertyagent.name}</h4>
                <div className={styles.ptcc__bot}>
                  <span>{currentLng==="fr" ? property.propertyagent.positionfr :property.propertyagent.positionen}</span>
                  <span>{t("portfolio:language")} : {currentLng==="fr"? property.propertyagent.languagesfr : property.propertyagent.languagesfr}</span>
                </div>
              </div>
            </div>
