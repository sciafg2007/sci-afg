...
interface PropertyProps {
  ...
  ahent: {
    name: string; positionfr: string; positionen: string; languagesfr: string; languagesen: string; whatsapp: string; phone: string;
  };
  quarter: string;
  city: {
    cityname: string;
...
const PropertyDetailPage = ({
  ...
  relatedProperties: Property2Props[];
}) => {
  const { t } = useT();
  ...
  return (
    <>
      ...
      <OtherProperties relatedProperties={relatedProperties}/>
      <Footer/>
    </>
  );
};
