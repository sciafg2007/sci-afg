  ...
  return (
    ...
    >
      <div className={styles.pb__top}>
        ...
        <span className={styles.tag}>{currentLocale==="fr" ? projectDetails.transaction.namefr : projectDetails.transaction.nameen}</span>
      </div>
      <div className={styles.pb__bottom}>
        <div className={styles.pbb__top}>
          <div className={styles.attr}>
            ...
            <span>{currentLocale==="fr" ? projectDetails.propertytype.namefr : projectDetails.propertytype.nameen}</span>
          </div>
          {projectDetails.room && (
