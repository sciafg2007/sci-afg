          ...
          <div className={styles.service__wrap} key={i}>
            ...
            <div className={styles.ser__right}>
              <div className={styles.sr__top}>
                <h4 className={styles.sr__h4}>{data.serhead}</h4>
                <p className={styles.sr__p}>{data.sertext}</p>
              </div>
              <div className={styles.sr__bottom}>
                <span className={styles.sr__span}>{t("services:serhero")}</span>

                <ul className={styles.sr__list}>
                  {
                    data.serpoints.map((point, i) => (
                      <li key={i}>{}</li>
                    ))
                  }
                </ul>
