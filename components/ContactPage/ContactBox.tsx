...
const ContactBox = () => {
  ...
  const FormFields = [
    ...
    },
    {
      ...
      errorMessage: t("contact:phoneerror"),
      required: true,
      minlength: 5,
      inputState: true,
    ...
    },
    {
      ...
      name: "subject",
      type: "text",
      placeholder: t("contact:subjectplace"),
    ...
    <div className={styles.contactbox}>
      <div className={styles.cb__content}>
        <div className={styles.cb__top}>
          <h3 className={styles.cb__h3}>{t("contact:message")}</h3>
          <p className={styles.cb__p}>{t("contact:reply")}</p>
        </div>
            ...
            >
              <div className={styles.text__section}>
                <div className={styles.ts__wrapper}>
                  <p className={styles.p}>{buttonText}</p>
                  <p className={styles.p}>{buttonText}</p>
                </div>
              </div>
              {isSubmitting ? (
