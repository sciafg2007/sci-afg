    ...
    >
      <div className={styles.side__wrap}>
        <div className={styles.sb__top}>
          ...
          <div className={styles.menu} onClick={() => setActiveSide(false)}>
            <span className={styles.menutext}>{t("common:close")}</span>
            <Cancel />
          </div>
        </div>
        ...
        <div className={styles.sidebot}>
          <div className={styles.loca}>
            <span className={styles.loca__span}>{t("home:location")}</span>
            <div className={styles.locone}>
              <span>7eme Etage Immeuble CCA, pharmacie du soleil</span>
              <span>Immeuble CCA Bonanjo, Douala</span>
              <span>CCA Douche</span>
            </div>
          </div>
          <div className={styles.loca}>
            <span className={styles.loca__span}>{t("home:contact")}</span>
            <div className={styles.locone}>
              <Link href="mailto:info.afrigroupe@sci-afg.com">
                info.afrigroupe@sci-afg.com
              </Link>
              <Link href="tel:+237655225161">+237 655 22 51 61</Link>
            </div>
          </div>
        </div>
      </div>
